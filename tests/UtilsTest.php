...
class UtilsTest extends TestCase
{
	...
	function dataLookupBlock()
	{
		return [
			...
			['{', '}', '{abc{def}efg{aaa{xyz}hch}} zdf', 0, [0, 25]],
			['{', '}', '{abc{def}ef}g{aaa{xyz}hch}} zdf', 0, [0, 11]],
			['{', '}', '{abc{def}efg{}}', 0, [0, 14]],
			['{', '}', '{abc{def}efg{ddd}}', 0, [0, 17]],
			['{', '}', 'Toto {blok a} abcde {blok {vnoreny blok} pokracuje} a konci.', 0, [5, 12]],
			['{', '}', 'Toto {blok a} abcde {blok {vnoreny blok} pokracuje} a konci.', 12, [20, 50]],
			['{', '}', '{abc\{def}efg}', 0, [0, 9]],
			['{', '}', '{abc\{def}}', 0, [0, 9]],
			['{', '}', '{abc\{def\}}', 0, [0, 11]],
			...
			['"', '"', '"abc"def""', 5, [8, 9]],
			['"', '"', '"abc"def""', 500, [False, False]],
			['"', '"', '"abc\"def"efg""xyz"hch"" zdf', 0, [0, 9]],
			['"', '"', '"abc\"def\"efg""xyz"hch"" zdf', 0, [0, 14]],
			['"', '"', '"abc\"def\"efg"\"xyz"hch"" zdf', 0, [0, 14]],
			['"', '"', '"abc\"def\"efg\""xyz"hch"" zdf', 0, [0, 16]],
			['"', '"', '"abc\\"def"efg""xyz"hch"" zdf', 0, [0, 9]],
			['"', '"', '"abc\\"def"efg"\"xyz"hch"" zdf', 0, [0, 9]],
		];
	}
