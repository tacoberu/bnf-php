...
class OneOfTest extends PHPUnit_Framework_TestCase
{
	...
	function _____testSample7_FIXME()
	{
		$sep = new Whitechars(Null, False);
		...
		$parser = new Variants(Null, [
			new OneOf(Null, [ // Tohle by nemělo fungovat. Z nějakého důvodu to povoílí OneOf znova. Ve variants by to mělo být na střídačku.
		...
		$src = '(col1 != :param1 OR col2 = :param2) col3 == :par1'; // Tohle by nemělo fungovat.
		$ast = $parser->match($src, 0, []);
		//~ dump($ast->content);
