...
class IndentTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$this->assertSame($expected, Indent::sliceBlock($src, $offset, Indent::calculateIndent($src, $offset)));
	}
...
";
		...
		$this->assertEquals(['val' => 0], $expected); // ? proč 0? Nemělo by to být 21?
